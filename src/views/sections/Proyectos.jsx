...
export default function Proyectos() {
  ...
  const proyectos = [
    ...
    },
    {
      ...
      buttonText: "Ver Proyecto",
      onButtonClick: () =>
        window.open("https://meteoappmg.netlify.app/", "_blank"),
    },
  ];

  return (
    <section
      className="scroll-section d-flex justify-content-center align-items-center flex-column proyectos-section"
      style={{
    ...
    >
      ...
      <div className="proyectos-text">Proyectos</div>
